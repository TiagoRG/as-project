    ...
    <div class="container position-relative">
        <div class="row mb-5">
            <div class="col-md-8 col-xl-6 text-center mx-auto">
                <h2><span style="color: rgb(11, 94, 215);">Contact Us</span></h2>
                <p class="w-lg-50">We want to hear from you! If you have any questions, feddback or need assistance,
                    please don't hesitate to contact us. Our team is here to help and we will do our best to answer your
                ...
                <div class="d-flex flex-column justify-content-center align-items-start h-100">
                    ...
                    <div class="d-flex align-items-center p-3">
                        ...
                        <div class="px-2">
                            ...
                            <p class="mb-0">Aveiro, Portugal</p>
                        </div>
                    </div>
                </div>
            </div>
